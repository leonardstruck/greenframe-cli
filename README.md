...
_See code: [dist/commands/analyze.ts](https://github.com/marmelab/greenframe-cli/blob/v2.0.2/dist/commands/analyze.ts)_
...
_See code: [dist/commands/kube-config.ts](https://github.com/marmelab/greenframe-cli/blob/v2.0.2/dist/commands/kube-config.ts)_
...
_See code: [dist/commands/open.ts](https://github.com/marmelab/greenframe-cli/blob/v2.0.2/dist/commands/open.ts)_
...
_See code: [dist/commands/update.ts](https://github.com/marmelab/greenframe-cli/blob/v2.0.2/dist/commands/update.ts)_
<!-- commandsstop -->
